import{E as v}from"./chunks/theme.Bw8xWCoO.js";import{P as x}from"./chunks/index.ZaXdYfd5.js";import{G as _,aj as m,L as p,M as u,F as D,a0 as n,W as h,_ as o,u as s,m as E,r as N,p as c,P as e,aS as q}from"./chunks/framework.DdxGngjQ.js";const k=_({__name:"basic",setup(b){const r=N();let t=c({});const l=c({title:"新建奖品",width:"520px"}),f=[{label:"奖品名",prop:"awardName",el:"input",rules:[{required:!0,message:"请输入奖品名",trigger:"blur"}]},{label:"类型",prop:"type",el:"select",enum:[{label:"实物",value:"1"},{label:"虚拟",value:"2"}],enterProps:{clearable:!0},rules:[{required:!0,message:"请选择类型",trigger:"change"}]}];function g(){var a;(a=r.value)==null||a.show({title:"新建奖品",formData:{awardName:"",type:""}})}function P(a){var d;v.success(`提交成功：${JSON.stringify(a)}`),(d=r.value)==null||d.hide()}return(a,d)=>{const y=m("el-button");return p(),u(D,null,[n(y,{type:"primary",onClick:g},{default:h(()=>[...d[1]||(d[1]=[o("打开弹窗",-1)])]),_:1}),n(s(x),{ref_key:"modalRef",ref:r,modelValue:s(t),"onUpdate:modelValue":d[0]||(d[0]=i=>E(t)?t.value=i:t=i),column:f,modal:l,validate:"",onSubmit:P},null,8,["modelValue","modal"])],64)}}}),F=`<template>
